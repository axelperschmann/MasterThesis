...
\begin{tikzpicture}[node distance = 16em, auto, thick]
    ...
    \draw[->] (A.52) node[above, xshift=2.7cm] {}  node[above, align=center, xshift=0.93cm]{1. Buy x}  -- (X2.158.5);
    
    \node[draw, black, dashed, minimum height=2.8cm, minimum width=6cm, line width=0.4mm, fill=black!20] at (7.9,-0.2) (X1) {};
    \draw[->] (A.42) node[above, xshift=2.7cm] {}  node[below, align=center, xshift=0.93cm]{2. Sell y} -- (X1.158.5);
    ...
    \draw[->] (A.-30) node[above, xshift=1.52cm] {3. Buy Bitcoins}  node[below, align=center, xshift=1.7cm]{for $70.000\$$,\\within 60min} -- (X);
