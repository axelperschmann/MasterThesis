...
Based on the same training data and simulator settings as in the Backward Sampling Experiments, the novel forward sampling approach (see \Cref{chap:forwardlearning}) is applied.\\
