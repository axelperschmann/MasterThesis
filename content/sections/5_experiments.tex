...
The best performing agent \lstinline!VolTimeSpread_disc5! now undercuts costs induced by simple market orders by $-49.59\%$ (before: $-49.16\%$), the gain in comparison to the optimal \ac{SL} strategy enlarged to $-9.70\%$ (before: $-8.93\%$).\\
...
{} &  \text{slippage} &     \text{med} &     \text{std} &   \text{perf\_2} &   \text{perf\_4} &   \text{perf\_M} & \text{perf\_VolTime} \\
\midrule
BT\_VolTime       &    143.24 &   38.53 &  373.35 &  -7.53\% &  -18.78\% &  -48.38\% &       -4.90\% \\
BT\_VolTimeLevel2 &    151.08 &   47.39 &  391.02 &  -2.47\% &  -14.34\% &  -45.55\% &        0.30\% \\
BT\_VolTimeSpread &    249.07 &  237.29 &  142.11 &  60.79\% &   41.22\% &  -10.24\% &       65.36\% \\
VolTime          &    150.63 &   33.83 &  358.66 &  -2.76\% &  -14.60\% &  -45.72\% &        0.00\% \\
2                &    154.90 &   68.62 &  389.15 &   0.00\% &  -12.17\% &  -44.18\% &        2.84\% \\
4                &    176.37 &  141.66 &  273.58 &  13.86\% &    0.00\% &  -36.44\% &       17.09\% \\
MarketOrder      &    277.49 &  246.48 &  158.66 &  79.14\% &   57.33\% &    0.00\% &       84.22\% \\
...
\begin{figure}[ht]
	...
	\begin{subfigure}[b]{0.8\textwidth}
        		...
        		\caption{QTable approximation by \lstinline!BT_VolTime!-agent.}
    	\end{subfigure}
	\begin{subfigure}[b]{0.8\textwidth}
        		\centering
