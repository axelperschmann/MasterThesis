...
\subsection{Markets}
Trades are typically organized through one of two basic market types:
\begin{description}
...
Bitcoin is a highly volatile currency, capable of massive price changes towards both directions within short periods of time. \Cref{fig:bitcoinvolatility} compares volatilities of currency pairs USDT/BTC (blue line) and USD/Pound (red line). A high volatility provides profitable opportunities, but comes at the price of higher risk.
