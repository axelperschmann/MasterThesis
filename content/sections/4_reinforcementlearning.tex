...
Various attempts have been made, to solve the issues discussed in \Cref{chap:backwardalgorithm:discussion}.\\

Issue 4 (action space) has been approached by replacing \lstinline!limit_buy = bid + a! with \\\lstinline!limit_buy = ask * (1 + (a/100))!  and  \lstinline!limit_sell = ask - a! with \lstinline!limit_sell = bid * (1 - (a/100))!. \\\Cref{fig:actionlimitmapping} compares the achieved performance for both versions.
...
interchanging bid price and ask price in \Cref{eq:imcost}.
