...
\begin{abstract}
\normalfont\normalsize
Diese Thesis befasst sich mit dem Problem der Optimalen Handelsausführung, welches darin besteht den bestmöglichen Preis für ein Finanzprodukt zu erzielen, dessen Handel von einer höheren Investitionsstrategie angeordnet wurde. Am leichtesten lässt sich dieses Problem beschreiben durch ein bestimmtes Finanzprodukt, welches innerhalb eines festgelegten Zeitraumes zum bestmöglichen Preis gekauft oder verkauft werden soll.

Hierfür wurde ein bestehender Reinforcement Learning Ansatz verbessert und ein neuartiger, vorwärts lernender Algorithm vorgestellt, der die kostenreduzierenden Fähigkeiten der vorherigen Methoden übertrifft. 
